...
if( ! empty( $cached_data['deals'] ) && is_array( $cached_data['deals'] ) ){ ?>
	<table class="tie-deals-table widefat" cellspacing="0">
		...
		<tbody>
	<tr>
		<td class="tie-deal-message"><h3>اینستاگرام آمر یاران</h3><p> قراره تو این پیج آموزش و بررسی افزونه‌ها و قلب‌های وردپرس رو داشته باشیم. مخصوصا قالب جنه ;)</p></td>
		<td><a href="https://www.instagram.com/ameryaran/" target="_blank" class="button button-primary">می‌خواهم عضو پیج اینستاگرام بشم</a></td>
	</tr>
	<tr>
		<td class="tie-deal-message"><h3>تلگرام آمر یاران</h3><p>اینجا هم قراره آموزش و بررسی افزونه‌ها و قلب‌های وردپرس رو داشته باشیم. مخصوصا قالب جنه ;)</p></td>
		<td><a href="https://t.me/ameryaran" target="_blank" class="button button-primary">می‌خواهم عضو کانال تلگرام بشم</a></td>
	</tr>
		</tbody>
	</table>
	<?php
